...
public class LikePostCommandHandlerTests
{
    ...
    private LikePostCommandHandler _handler;
    ...
    public void Setup()
    {
        ...
        _handler = _moq.Create<LikePostCommandHandler>();
    }
    ...
    [Test]
    public async Task Handle_ValidPost_IncrementsLikeAndReturnsCount()
    {
        // Arrange
