...
public class GetPublishedPostQueryHandlerTests
{
    private AutoMock _moq;
    private GetPublishedPostQueryHandler _handler;
    ...
    public void Setup()
    {
        ...
        _handler = _moq.Create<GetPublishedPostQueryHandler>();
    }
    ...
    [Test]
    public async Task Handle_ValidQuery_ReturnsPublishedPosts()
    {
        // Arrange
        ...
        {
            new Post { Id = Guid.NewGuid(), Title = "Published 1", IsPublished = true },
            new Post { Id = Guid.NewGuid(), Title = "Published 2", IsPublished = true }
        };
        ...
        result.Item1[0].Title.ShouldBe("Published 1");
